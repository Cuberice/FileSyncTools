...
namespace WindowsExplorer
{
	...
	public class ExplorerTree : System.Windows.Forms.UserControl
	{
		...
		private bool startWithMyComputer = true;
		...
		public bool StartWithMyComputer
		{
			get { return startWithMyComputer; }
			set { startWithMyComputer = value; }
		}
		...
		public void SetViewToMyComputer()
		{
		...
		public TreeView TreeView { get { return tvwMain; } }
		...
		private void InitializeComponent()
		{
			...
			this.btnRefresh.Location = new System.Drawing.Point(125, 8);
			...
			this.tvwMain.SelectedImageIndex = 29;
			...
			this.tvwMain.AfterLabelEdit += new System.Windows.Forms.NodeLabelEditEventHandler(this.tvwMain_LabelChanged);
			...
			this.imageList1.Images.SetKeyName(29, "folder_green.png");
			// 
			// btnHome
			// 
			...
			this.btnHome.Location = new System.Drawing.Point(147, 8);
			...
			this.btnBack.Location = new System.Drawing.Point(59, 8);
			...
			this.btnNext.Location = new System.Drawing.Point(81, 8);
			...
			this.btnUp.Location = new System.Drawing.Point(103, 8);
			...
			// btnAddLink
			// 
			this.btnAddLink.BackColor = System.Drawing.Color.White;
			this.btnAddLink.Cursor = System.Windows.Forms.Cursors.Hand;
			this.btnAddLink.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.btnAddLink.ForeColor = System.Drawing.Color.Transparent;
			this.btnAddLink.Image = ((System.Drawing.Image)(resources.GetObject("btnAddLink.Image")));
			this.btnAddLink.Location = new System.Drawing.Point(8, 8);
			this.btnAddLink.Name = "btnAddLink";
			this.btnAddLink.Size = new System.Drawing.Size(19, 17);
			this.btnAddLink.TabIndex = 70;
			this.toolTip1.SetToolTip(this.btnAddLink, "Add shortcut to frequently used folders");
			...
			this.btnInfo.Location = new System.Drawing.Point(168, 8);
			...
			// btnAddDir
			// 
			this.btnAddDir.BackColor = System.Drawing.Color.White;
			this.btnAddDir.Cursor = System.Windows.Forms.Cursors.Hand;
			this.btnAddDir.FlatStyle = System.Windows.Forms.FlatStyle.Flat;
			this.btnAddDir.ForeColor = System.Drawing.Color.Transparent;
			this.btnAddDir.Image = ((System.Drawing.Image)(resources.GetObject("btnAddDir.Image")));
			this.btnAddDir.Location = new System.Drawing.Point(31, 9);
			this.btnAddDir.Name = "btnAddDir";
			this.btnAddDir.Size = new System.Drawing.Size(19, 17);
			this.btnAddDir.TabIndex = 72;
			this.toolTip1.SetToolTip(this.btnAddDir, "Add New Directory");
			...
			this.grptoolbar.Anchor = ((System.Windows.Forms.AnchorStyles)(((System.Windows.Forms.AnchorStyles.Top | System.Windows.Forms.AnchorStyles.Left)
									| System.Windows.Forms.AnchorStyles.Right)));
			this.grptoolbar.Controls.Add(this.btnAddDir);
			...
			this.grptoolbar.Controls.Add(this.btnAddLink);
		...
		private void ExplorerTree_Load(object sender, System.EventArgs e)
		{
			...
			setCurrentPath(selectedPath != string.Empty && Directory.Exists(selectedPath) ? selectedPath : "home");
			btnGo_Click(this,e); 
			refreshView();

			if (StartWithMyComputer)
				SetViewToMyComputer();
		}
		...
		private void updateList(string f)
{
	...
	MessageBox.Show(e.Message);   
		...
		private void btnAddLink_Click(object sender, System.EventArgs e)
		{
			string myname="";
			string mypath="";
		...
		{
			if (string.IsNullOrEmpty(SelectedPath) || TreeView.SelectedNode == null)
				return;

			try
			{
				DirectoryInfo parentDir = new DirectoryInfo(SelectedPath);
				DirectoryInfo dir = parentDir.CreateSubdirectory("New Folder");

				TreeNode pnode = TreeView.SelectedNode;
				TreeNode newNode = pnode.Nodes.Add(dir.Name, dir.Name, 1);
				TreeView.SelectedNode = newNode;
				newNode.BeginEdit();

				//GetDirectories(TreeView.SelectedNode);
			}
			catch (Exception x)
			{
				Trace.WriteLine(x);
		...
		private void tvwMain_LabelChanged(object sender, NodeLabelEditEventArgs e)
		{
			DirectoryInfo dir = new DirectoryInfo(SelectedPath);
			string newDir = dir.FullName.Replace(dir.FullName, e.Label);
